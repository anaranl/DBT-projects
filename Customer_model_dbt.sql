-- MODEL CREATED TO POPULATE CUSTOMER DATA (table1 AND table2) FROM SPECIFIC SOURCE FOLLOWING CERTAIN PROPERTIES -- 


{{ config(materialized='table') }}

//---- *CTEs to collect properties from both table1 and table2 * //
